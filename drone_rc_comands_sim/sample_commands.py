...
rc_commands1 = [
    ...
    [1100, 1500, 1500, 1500],  # hover
    [1100, 1500, 1600, 1500],  # roll left
    [1100, 1600, 1500, 1500],  # pitch back
    [1000, 1500, 1500, 1500],  # down
    [1000, 1500, 1400, 1500],  # up + right
    [1000, 1400, 1500, 1500],  # up + forward
    [1000, 1500, 1500, 1500],  # up
]
